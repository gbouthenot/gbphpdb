...
Class Gb_Emailverif
{
     ...
     * ) ENGINE = InnoDB COMMENT = 'Stock les adresses mail valid�es par le web';
     */
     ...
     * @param Gb_Db $db
     * @param integer[optional] $hoursValidy nombre d'heures (d�faut 48) que la validation est consid�r�e comme valide
     * @param string[optional] tablename (d�faut mail_verif)
     */
